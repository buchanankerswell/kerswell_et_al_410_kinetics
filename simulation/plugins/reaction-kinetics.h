...
#ifndef _aspect_cookbooks_reaction_kinetics_reaction_kinetics_h
#define _aspect_cookbooks_reaction_kinetics_reaction_kinetics_h
...
namespace aspect
{
  namespace MaterialModel
  {
     ...
     */
    template <int dim>
    class ReactionKinetics : public MaterialModel::Interface<dim>, public ::aspect::SimulatorAccess<dim>
    {
      public:
        /**
      ...
      private:
         ...
         * of state and reaction kinetics. The thermodynamic data are evaluated along a
         ...
         * thermodynamic driving force in the ReactionKinetics material model.
         *
    ...
    /**
     * Additional output fields for the ReactionKinetics material model
     ...
     */
    template <int dim>
    class ReactionKineticsOutputs : public NamedAdditionalMaterialOutputs<dim>
    {
      public:
        ReactionKineticsOutputs(const unsigned int n_points);
