...
def main():
    ...
    tile_sets = {
        "set0": {"tags": None, "fields": ["nonadiabatic_temperature", "nonadiabatic_density", "seismic_Vp"]},
        "set1": {"tags": None, "fields": ["nonadiabatic_temperature", "reaction_rate_C0", "X_field"]},
        # "set2": {"tags": None, "fields": ["nonadiabatic_temperature", "nonadiabatic_pressure", "nonadiabatic_density"]},
        # "set3": {"tags": None, "fields": ["arrhenius", "thermodynamic", "reaction_rate_C0", ]},
        # "set4": {"tags": None, "fields": ["X_field", "seismic_Vp", "seismic_Vs", ]},
        # "set5": {"tags": None, "fields": ["viscosity", "stress_second_invariant", "strain_rate"]},
    }
